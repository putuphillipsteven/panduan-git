...
### **Git**
Saya juga kurang paham, namun Git itu adalah sebuah perusahaan(menurut pendapat saya) yang membuat GitHub(menurut pendapat saya), yang membuat sebuah fitur agar developer dapat mengerjakan dan menyimpan codingannya secara online, di sebuah tempat yang bernama **repository**. Lalu, apa itu [repository](#repository)?

### **Repository**

Merupakan adalah tempat kita simpan kerjaan kita secara online. Repo ini dapat dikerjakan secara bersamaan oleh banyak developer, tapi kan, kalo kita kerjain semua nya di tempat yang sama, bakalan tabrakan kan. Maka dari itu, ada sebuah fitur yang bernama **branch**. 
...
```
[nama-developer-migrasi] contoh : john-doe-migrasi
```
...
pada case ini, saya contohkan clnone repo claimq 
...
Kenapa feat/dashboard-testing? karena, kami tim ClaimQ telah menyetujui rule naming branch ini. Feat itu adalah singkatan dari feature. Nantinya, akan ada rule naming lain yang ada peraturannya, namun, karna ini migrasi, kita anggap saja semua itu adalah fitur ya. Bagaimana [cara membuat branch baru](#cara-membuat-branch-baru)?
...
![alt text](image-15.png) maka akan muncul list port yang sedang berjalan
</li>
